...
// Buat Database
$query = "CREATE DATABASE IF NOT EXISTS praktikum2";
$result = mysqli_query($connection, $query);
if (!$result) {
    die("Query Error: " . mysqli_errno($connection) . " - " . mysqli_error($connection));
} else {
    echo "Database <b>'praktikum2'</b> berhasil dibuat... <br>";
}

// Pilih Database
$result = mysqli_select_db($connection, "praktikum2");
if (!$result) {
    die("Query Error: " . mysqli_errno($connection) . " - " . mysqli_error($connection));
} else {
    echo "Database <b>'praktikum2'</b> berhasil dipilih... <br>";
}

// Buat Tabel student (hapus jika sudah ada)
...
// Insert data student
$query = "INSERT INTO student (nim, name, birth_city, birth_date, faculty, department, gpa) VALUES
...
// Buat Tabel admin (hapus jika sudah ada)
