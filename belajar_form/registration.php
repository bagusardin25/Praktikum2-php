            ...
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="text" name="student_number" value="<?= $student_number ?>" size="20" placeholder="NIM Anda">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <textarea name="student_address" cols="30" rows="5" placeholder="Alamat Anda"><?= $student_address ?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>Tanggal Lahir*</td>
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="email" name="student_email" value="<?= $student_email ?>" size="20" placeholder="Email Anda">
                        </td>
                    </tr>
                    <tr>
                        <td>Username*</td>
                        <td>:</td>
                        <td>
                            <input type="text" name="student_username" value="<?= $student_username ?>" size="20" placeholder="Username Anda">
                        </td>
                    </tr>
                    <tr>
                        <td>Password*</td>
                        <td>:</td>
                        <td>
                            <input type="password" name="student_password" value="<?= $student_password ?>" size="20" placeholder="Password Anda">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="password" name="student_password_confirmation" value="<?= $student_password_confirmation ?>" size="20" placeholder="Password Anda">
                        </td>
                    </tr>
                </table>
            </fieldset>
