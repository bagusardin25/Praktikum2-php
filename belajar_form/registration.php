...
scale=1.0">
  ...
  <meta name="description" content="Halaman praktikum modul 8 mata
kuliah pemrograman web di program studi sistem informasi">
  ...
  <div class="container">
    ...
    <form action="registration.php" method="post"
      ...
      <div>
        ...
        <input type="submit" name="submit" value="Deletet">
      </div>
    </form>
    <div>
</body>
